namespace WindowsFormsApplication1
{
    partial class Editing
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panel1.Size = new System.Drawing.Size(523, 229);
            ...
            this.groupBox2.Size = new System.Drawing.Size(517, 223);
            this.groupBox2.TabIndex = 2;
            this.groupBox2.TabStop = false;
            this.groupBox2.Text = "Введіть інформацію";
            this.groupBox2.Enter += new System.EventHandler(this.groupBox2_Enter);
            // 
            // groupBox7
            // 
            this.groupBox7.Controls.Add(this.comboBox6);
            this.groupBox7.Location = new System.Drawing.Point(293, 168);
            ...
            this.groupBox5.Location = new System.Drawing.Point(139, 133);
            this.groupBox5.Name = "groupBox5";
            this.groupBox5.Size = new System.Drawing.Size(148, 80);
            this.groupBox5.TabIndex = 8;
            this.groupBox5.TabStop = false;
            this.groupBox5.Text = "Стать";
            // 
            // radioButton1
            // 
            ...
            this.groupBox6.Location = new System.Drawing.Point(293, 19);
            ...
            // button_OK
            // 
            this.button_OK.Location = new System.Drawing.Point(11, 190);
            this.button_OK.Name = "button_OK";
            this.button_OK.Size = new System.Drawing.Size(122, 23);
            this.button_OK.TabIndex = 3;
            this.button_OK.Text = "Редагувати";
            ...
            this.groupBox4.Location = new System.Drawing.Point(11, 133);
            this.groupBox4.Name = "groupBox4";
            this.groupBox4.Size = new System.Drawing.Size(106, 51);
            this.groupBox4.TabIndex = 2;
            this.groupBox4.TabStop = false;
            this.groupBox4.Text = "Клас";
            // 
            // comboBox1
            // 
            ...
            this.groupBox3.Text = "Навчальний заклад";
            // 
            // comboBox2
            // 
            ...
            "Житомирський ліцей №2",
            "Міська гімназія №3  м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №5 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №6  ім. В.Г.Короленка м.Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №7 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №8 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №10 м. Житомира",
            "Спеціалізована загальноосвітня школа І-ІІІ ступенів №12 ім.С.Ковальчука м. Житоми" +
                "ра",
            "Загальноосвітня школа І-ІІІ ступенів №14 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №15 м. Житомира",
            "Загальноосвітня спеціалізована школа І-ІІІ ступенів №16 м.Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №17 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №19 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №20 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №21 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №22 м. Житомира",
            "Житомирська гуманітарна гімназія №23 ім. М.Й.Очерета",
            "Загальноосвітня І-ІІІ ступенів школа №24 м. Житомира",
            "Ліцей №25 ім. М.О.Щорса м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №26 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №27 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №28 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №30 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №32 м. Житомира",
            "Загальноосвітня школа І-ІІІ ступенів №33 м. Житомира",
            ...
            "Вечірня загальноосвітня школа ІІ-ІІІ ступенів №1 м. Житомира",
            "Вечірня загальноосвітня школа ІІ-ІІІ ступенів №2 м. Житомира",
            "Загальноосвітня школа “Сяйво”",
            "Гімназія “Ор Авнер”",
            "Загальноосвітня школа “Всесвіт”",
